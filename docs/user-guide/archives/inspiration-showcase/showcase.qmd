...
1) Introduce the VirtualShip Classroom and its components
2) Walk through an example workflow of how the components can be used
3) The NKO Scale Up: what we will provide and what is expected from your side
4) Q&A
...
## `VirtualShip` software internals {.smaller}
...
- <span style="vertical-align: middle;">
    ...
    - VirtualShip = `kernels` + configuration + digital ocean
...
## The NKO Scale Up {.smaller}

- We will:
    - Provide and continue to develop core VirtualShip Classroom (VSC) materials
    - Run train-the-trainer sessions
    - Provide high-level project management and coordination
    - Engage in discussions over to what extent we can tailor VirtualShip to your needs

- From your side:
    - Intended learning outcomes (what do you want to use the VSC for?)
    - Commitment for 2 academic years
    - On-the-ground delivery of the course at your institution
    - Recruit Student Assistants to support course delivery (via NKO funding)
    - Ask participants to complete a feedback survey (we provide the survey)
    - Inform us of technical setup and needs for the software and VR content
    - Contribute to the materials and software if you wish
